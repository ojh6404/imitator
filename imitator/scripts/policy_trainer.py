...
flags.DEFINE_integer("epochs", 10000, "Number of epochs for finetuning.")
flags.DEFINE_integer("seed", 42, "Seed for reproducibility.")
flags.DEFINE_string("pretrained", None, "Path to pretrained checkpoint.")
flags.DEFINE_bool(
...
def main(_):
    ...
    train_data = make_single_dataset(
        dataset_kwargs=dict(
            ...
            data_dir="/home/oh/tensorflow_datasets",
            image_obs_keys={
                "primary": "agentview_image",
                "wrist": "robot0_eye_in_hand_image",
            },
            state_obs_keys=["robot0_eef_pos"],  # TODO
        ...
        frame_transform_kwargs=dict(
            resize_size={"primary": (64, 64), "wrist": (64, 64)},
        ),
        train=True,
    )
    ...
    print(example_batch["observation"].keys())
    ...
    print("init_rng type: ", type(init_rng))
